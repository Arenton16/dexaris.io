...
const HERO_TIERS = [
  ...
  { key: 'solid',    label: '60–79 Solid',    min: 60, colour: '#14B8B8' },
...
function ChainIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" stroke="#0E7C7C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" stroke="#0E7C7C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function StarIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" stroke="#0E7C7C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function ScoreIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="9" stroke="#0E7C7C" strokeWidth="1.5" />
      <path d="M8 12l3 3 5-5" stroke="#0E7C7C" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function scoreColour(score: number): string {
  ...
  if (score >= 60) return '#14B8B8';
  if (score >= 40) return '#FFB347';
  return '#FF6B6B';
}

const BG_DOT_COLOURS = ['#4ECDA4', '#14B8B8', '#FFB347', '#FF6B6B'];
    ...
    <div style={{ background: '#050505', minHeight: '100vh', fontFamily: "'Inter', sans-serif", color: '#F2F2F2' }}>
        ...
        <div className="hero-grid" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '24px', textAlign: 'left' }}>
            ...
            <h1 className="hero-headline" style={{
              ...
              Find the yield<br />
              <span style={{ color: '#14B8B8' }}>worth chasing.</span>
            </h1>
            ...
            >
              ...
              {link && (
                <a
                  ...
                  style={{ display: 'inline-block', fontSize: '12px', color: '#14B8B8', marginTop: '12px', textDecoration: 'none' }}
                >
                  {linkLabel} →
                </a>
              )}
      ...
      <section id="newsletter" className="newsletter-section" style={{
        ...
        >
          ...
          {subStatus === 'success' ? (
            <p style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#14B8B8', fontWeight: 500, margin: 0 }}>
              <span style={{
