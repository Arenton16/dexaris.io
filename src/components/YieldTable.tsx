...
function FilterChip({
  ...
  const style: React.CSSProperties = active
    ? (activeScheme === 'score'
      ...
      : { background: 'rgba(255,255,255,0.15)', border: '0.5px solid rgba(107,84,255,0.35)', color: '#5DCACA' })
                    ...
                    >
                      ...
                      <td className="protocol">
                        <div className="protocol-cell">
                          ...
                          {pool.project}
                          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '3px', fontSize: '10px', fontWeight: 600, padding: '2px 7px', borderRadius: '10px', background: 'rgba(255,255,255,0.15)', border: '0.5px solid rgba(255,255,255,0.4)', color: '#14B8B8', marginLeft: '8px', letterSpacing: '0.3px', textTransform: 'uppercase', visibility: pool.pool === bestPickId ? 'visible' : 'hidden' }}>✦ Best Pick</span>
                        </div>
                      </td>
                      <td>{pool.symbol}</td>
                      <td>
      ...
      >
        <button
          ...
          style={{
            ...
            color: 'rgba(242,242,242,0.4)', fontSize: 18, lineHeight: 1,
            padding: '2px 6px',
          }}
          aria-label="Close"
        >×</button>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
          ...
          <h3 style={{ margin: 0, fontSize: 16, fontWeight: 600, color: '#F2F2F2' }}>Dexaris Score</h3>
        </div>
        ...
        <div style={{ marginBottom: 20 }}>
          {tiers.map(t => (
            <div key={t.label} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 7 }}>
              ...
              <span style={{ fontSize: 12, color: 'rgba(242,242,242,0.4)' }}>{t.range}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{ marginBottom: 20 }}>
          <p style={{ margin: '0 0 10px', fontSize: 11, color: 'rgba(242,242,242,0.35)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Components</p>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr>
                <th style={{ textAlign: 'left', fontSize: 11, color: 'rgba(242,242,242,0.35)', fontWeight: 500, paddingBottom: 6, paddingRight: 8 }}>Component</th>
                <th style={{ textAlign: 'right', fontSize: 11, color: 'rgba(242,242,242,0.35)', fontWeight: 500, paddingBottom: 6 }}>Weight</th>
              </tr>
            </thead>
            <tbody>
              {components.map((c, i) => (
                <tr key={c.name} style={{ background: i % 2 === 0 ? 'rgba(255,255,255,0.04)' : 'transparent' }}>
                  <td style={{ fontSize: 13, color: 'rgba(242,242,242,0.75)', padding: '6px 8px 6px 0' }}>{c.name}</td>
        ...
        <p style={{ margin: 0, fontSize: 11, color: 'rgba(242,242,242,0.25)', textAlign: 'center' }}>
